# DHAPPA v3.2 — Contextual Rescue Attribution Lab
...
- **Ghaziabad:** frozen proposals=146, live rescue activations=12, shadow samples=146
...
## Contextual rescue attribution
- **Deshawar:** contextual proposals=134, contexts-survived=0, live contextual rescues=0
- **Faridabad:** contextual proposals=129, contexts-survived=0, live contextual rescues=0
- **Ghaziabad:** contextual proposals=146, contexts-survived=15, live contextual rescues=12
- **Gali:** contextual proposals=129, contexts-survived=0, live contextual rescues=0

A contextual rescue can activate only if the broad v3.1 survival gate and at least one prior-only contextual cohort both survive. Same-target outcomes never define their own context eligibility.